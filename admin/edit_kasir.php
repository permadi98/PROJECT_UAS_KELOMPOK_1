...
if(isset($_POST['edit'])){
			...
			$update = $DB_con->prepare("UPDATE kasir SET nama='$nama', alamat='$alamat', telepon='$telepon', status='$status', username='$username'
											, akses='$akses' WHERE id_kasir='$id_kasir'");
				if($update->execute()){
...
?>
                                ...
                                <div class="card-body">
									...
									<tr>
										...
										<option value="">- akses terbaru -</option>
										<option value="kasir">Kasir</option>
										<option value="admin">Admin</option>
										</select>
										</div>
										<div class="col-sm-6">
										<b>Akses Sekarang :</b> <span class="label label-info" style="font-size:15px;"><?php echo $edit['akses']; ?></span>
										</div>
										</td>
									</tr>
									<tr>
