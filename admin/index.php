                ...
                <nav class="navbar navbar-default" role="navigation">
                    <div class="side-menu-container">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active">
                                <a href="index.php">
                                    <span class="icon fa fa-thumbs-o-up"></span><span class="title">Halaman Admin</span>
                                </a>
                            </li>
							<li>
                                <a href="kasir.php">
                                    <span class="icon fa fa-user"></span><span class="title">Data Kasir</span>
                                </a>
                            </li>
							<li>
                                <a href="distributor.php">
                                    <span class="icon fa fa-users"></span><span class="title">Distributor</span>
                                </a>
                            </li>
							<li>
                                <a href="buku.php">
			...
			<div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title" style="color:#9900FF;">Selamat datang di halaman admin <?php echo $kasir['nama'] ?></span>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
