                        ...
                        <div class="col-xs-12">
                            <div class="card">
                                <div class="card-header">
									...
									<br>
                                    <div class="title">Laporan Penjualan Buku</div>
									<br>
                                    </div>
                                </div>
                                <div class="card-body">
									<center><legend><h2>Laporan Penjualan Buku</h2></legend></center>
<form method="post" action="../laporan/lap_jual_pdf.php" target='_blank'>
